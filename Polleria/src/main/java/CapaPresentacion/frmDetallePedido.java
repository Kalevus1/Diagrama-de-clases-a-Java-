...
public class frmDetallePedido extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtConsigna, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)
                            .addComponent(txtCant)
                            .addComponent(txtPertenece, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE))
    ...
    private void btnEscribirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEscribirActionPerformed
        // TODO add your handling code here:
        txtCod.setText(detallePedido.getCodDetallePedido()+"");
        txtCant.setText(detallePedido.getCantDetallePedido()+"");
        JOptionPane.showMessageDialog(this,"\nCodigo:" +detallePedido.getCodDetallePedido()+ "\nCantidad: " +detallePedido.getCantDetallePedido());
    }//GEN-LAST:event_btnEscribirActionPerformed

    private void btnLeerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLeerActionPerformed
        // TODO add your handling code here:
        char codDetallePedido = txtCod.getText().charAt(0);
        Double cantDetallePedido = Double.parseDouble(txtCant.getText());
        String consignaProd = txtConsigna.getText();
        String pertenecePedido = txtPertenece.getText();
                
        detallePedido.setCodDetallePedido(codDetallePedido);
        detallePedido.setCantDetallePedido(cantDetallePedido);
        Limpiar();
